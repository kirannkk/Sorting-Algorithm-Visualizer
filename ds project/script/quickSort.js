...
function quick_partition(start, end) {
    ...
    div_update(divs[start], div_sizes[start], "#FF8B41");//Color update
    ...
    for (var j = start + 1; j <= end; j++) {
        ...
        if (div_sizes[j] < piv) {
            ...
            div_update(divs[i], div_sizes[i], "#9F6CD0");//Height update
            div_update(divs[j], div_sizes[j], "#9F6CD0");//Height update

            i += 1;
        }
    }
    div_update(divs[start], div_sizes[start], "#FFB980");//Color update
    ...
    div_update(divs[start], div_sizes[start], "#FFB980");//Height update
